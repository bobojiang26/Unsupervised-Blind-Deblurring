...
class TrainOptions():
  def __init__(self):
    ...
    # codebook settings
    self.parser.add_argument('--codebook_size', type=int, default=1024, help='codebook_size')
    self.parser.add_argument('--embed_dim', type=int, default=256, help='the embedding dimension of codes in the codebook')
    ...
    self.parser.add_argument('--result_dir', type=str, default='../results_codecyclegan', help='path for saving result images and models')
    ...
    self.parser.add_argument('--n_ep_ts1', type=int, default=20, help='number of epochs') # 400 * d_iter
    self.parser.add_argument('--n_ep_ts2', type=int, default=100, help='number of epochs')
